...
for sim = 1:num_simulations
    ...
    % Calculate RMS error for this simulation
    rms_error = sqrt(mean((x_payload_positions - x_payload_des).^2 + ...
                          (y_payload_positions - y_payload_des).^2 + ...
                          (z_payload_positions - z_payload_des).^2));
    rms_errors(sim) = rms_error;
...
title('Histogram of RMS Errors over 15000 Simulations', 'FontSize', 14);
